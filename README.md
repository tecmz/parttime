...
- [新功能] 企业VIP每日查看简历数量限制
- [新功能] 增加仅认证企业可查看简历功能开关
- [新功能] 未查看简历姓名和联系方式隐私保护
- [新功能] 默认集成短信接口和智能验证码
...
- [Bug修复] 工作岗位编辑性别不能选择不限问题
- [Bug修复] 工作岗位编辑工作时间显示异常问题
- [Bug修复] 简历投递异常问题修复
- [Bug修复] 一处图片分片上传异常问题
...
- [系统优化] 讨论功能帖子回复分页大小设置为100
- [系统优化] 帖子回复位置锚点增加，自动跳转到帖子回复位置
- [系统优化] 表单快速编辑功能优化
...
- [新功能] 发帖和回帖审核白名单
- [新功能] 手机验证码注册兼容两种角色注册方式
- [Bug修复] 后台管理页面异常问题
- [Bug修复] 首页新闻手机端排版异常问题
- [Bug修复] 修复身高单位问题
- [Bug修复] 工作岗位信息Logo显示异常问题
...
- [新功能] 用户登录完成默认跳转到用户中心
- [新功能] 接口异常友好提示
- [新功能] 升级 member_cert_individual 表名
